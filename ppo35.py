...
#experiment_name = "MicrortsDefeatCoacAIShaped-v3__ppo3__1__1748061830"
...
for update in range(starting_update, num_updates + 1):
    ...
    for step in range(0, args.num_steps):
        ...
        winloss = 0.01#min(0.01, 2.72222222e-9 * global_step)
        densereward = 0.8# max(0, 0.8 + (-4.44444444e-9 * global_step))
        scorew = 0.19
