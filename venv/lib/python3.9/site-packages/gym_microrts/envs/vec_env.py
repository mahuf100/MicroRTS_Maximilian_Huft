...
class MicroRTSVecEnv:
    ...
    def __init__(self,
        ...
        if not jpype._jpype.isStarted():
            ...
            registerDomain("ai")
            jars = [
                "microrts.jar", "RAISocketAI.jar","Coac.jar", "Droplet.jar", "GRojoA3N.jar",
        ...
        from ai.reward import ProduceHeavyUnitRewardFunction,ProduceLightUnitRewardFunction,  ProduceRangedUnitRewardFunction,RewardFunctionInterface,  WinLossRewardFunction, ResourceGatherRewardFunction, AttackRewardFunction, ProduceWorkerRewardFunction, ProduceBuildingRewardFunction, ScoreRewardFunction, CloserToEnemyBaseRewardFunction
    ...
    def _encode_obs(self, obs):
        ...
        obs = obs.clip(0, np.array([self.num_planes]).T - 1)
